...
cljs.core.IndexedSeq.prototype.cljs$core$ISeq$_rest = function() {
  return cljs.core.truth_(cljs.core.lt_.call(null, this.i + 1, this.a.length)) ? new cljs.core.IndexedSeq(this.a, this.i + 1) : cljs.core.list.call(null)
};
...
cljs.core.reset_BANG_ = function(a, b) {
  ...
  a.state = b;
  cljs.core._notify_watches.call(null, a, a.state, b);
  return b
};
...
var janusclojure = {log:function(a) {
  return console.log(a)
}};
janusclojure.random_text_input = goog.dom.getElement.call(null, "random-text");
janusclojure.data_from_result = function(a) {
  a = a.target.getResponseText();
  janusclojure.log.call(null, a);
  return cljs.reader.read_string.call(null, a)
};
janusclojure.fetch_clicked = function() {
  return goog.net.XhrIo.send.call(null, "/uuid", function(a) {
    a = a.target.getResponseText();
    a = cljs.reader.read_string.call(null, a);
    return janusclojure.random_text_input.value = "\ufdd0'uuid".call(null, a)
  })
};
janusclojure.receive_result = function(a) {
  return goog.dom.appendChild.call(null, goog.dom.getElement.call(null, "info"), goog.dom.createDom.call(null, "pre", null, cljs.core.get.call(null, janusclojure.data_from_result.call(null, a), "\ufdd0'result")))
};
janusclojure.send_button_clicked = function() {
  var a = goog.dom.getElement.call(null, "your-name").value, b = goog.dom.getElement.call(null, "your-number").value, c = janusclojure.random_text_input.value;
  return goog.net.XhrIo.send.call(null, "/process", janusclojure.receive_result, "POST", cljs.core.pr_str.call(null, cljs.core.ObjMap.fromObject(["\ufdd0'your-name", "\ufdd0'your-number", "\ufdd0'random"], {"\ufdd0'your-name":a, "\ufdd0'your-number":janusclojure.int$.call(null, b), "\ufdd0'random":c})))
};
goog.events.listen.call(null, goog.dom.getElement.call(null, "getUUID"), goog.events.EventType.CLICK, janusclojure.fetch_clicked);
goog.events.listen.call(null, goog.dom.getElement.call(null, "sendBtn"), goog.events.EventType.CLICK, janusclojure.send_button_clicked);
